"""
PROGRAMA 4 (GRASP) — Cobertura de Combinações de 12 Elementos.

Variante por metaheurística GRASP multistart do Programa 4. Coexiste com o
program4.py original (construção direta), sem substituí-lo: grava em
logs/program4_grasp.log, separado de logs/program4.log.

Objetivo (enunciado): determinar SB₁₅,12 ⊆ S₁₅ tal que
