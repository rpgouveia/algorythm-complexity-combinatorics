"""
PROGRAMA 5 (GRASP) — Cobertura de Combinações de 11 Elementos.

Variante por metaheurística GRASP multistart do Programa 5. Coexiste com o
program5.py original (construção direta), sem substituí-lo: grava em
logs/program5_grasp.log, separado de logs/program5.log.

Objetivo (enunciado): determinar SB₁₅,11 ⊆ S₁₅ tal que
